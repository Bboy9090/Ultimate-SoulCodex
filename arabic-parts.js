...
export function calculateArabicParts(ascendantLongitude, sunLongitude, moonLongitude, venusLongitude, jupiterLongitude, saturnLongitude, isDayBirth // Sun above horizon
) {
    ...
    const partOfFortune = createPart("Part of Fortune", fortuneLongitude, "Material well-being, worldly success, and where life flows easily");
    const partOfSpirit = createPart("Part of Spirit", spiritLongitude, "Spiritual purpose, inner fulfillment, and soul's calling");
    const partOfLove = createPart("Part of Love", loveLongitude, "Romantic attraction, love nature, and heart's desire");
    const partOfMarriage = createPart("Part of Marriage", marriageLongitude, "Partnership potential, marriage themes, and union");
    const partOfFather = createPart("Part of Father", fatherLongitude, "Paternal influence, authority, and masculine legacy");
    const partOfMother = createPart("Part of Mother", motherLongitude, "Maternal influence, nurturing, and feminine legacy");
    return {
        partOfFortune,
        partOfSpirit,
        partOfLove,
