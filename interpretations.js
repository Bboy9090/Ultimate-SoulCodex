...
export const PLANET_SIGN_INTERPRETATIONS = {
    sun: {
        "Aries": {
...
const PLANET_MEANINGS_USER_FRIENDLY = {
    sun: {
        name: "Your Sun",
...
const SIGN_MEANINGS_USER_FRIENDLY = {
...
export function getPlanetSignInterpretation(planet, sign) {
...
function generateRealLifeExamples(planet, sign, keywords) {
    const planetInfo = PLANET_MEANINGS_USER_FRIENDLY[planet];
    const signInfo = SIGN_MEANINGS_USER_FRIENDLY[sign];
    ...
    if (planet === 'moon' && sign === 'Sagittarius') {
        examples.push("You might find yourself naturally lifting others' spirits when they're down", "You may feel emotionally nourished by learning, travel, or spiritual practices", "Your mood tends to be generally positive, and you can bounce back from setbacks more easily than most", "You might feel emotionally connected to philosophy, higher learning, or exploring different cultures");
    }
    else {
...
const HOUSE_MEANINGS_USER_FRIENDLY = {
...
export function getHouseInterpretation(house) {
...
export function getPlanetMeaning(planet) {
...
export function getKarmicInterpretation(point, sign) {
...
export function getAspectInterpretation(planet1, planet2, aspectType) {
    ...
    const fallback = aspectDescriptions[aspectType] || aspectDescriptions.conjunction;
    return {
