 ...
 */
export function calculateSolarReturn(profile, returnYear) {
 ...
 */
export function calculateLunarReturn(profile, returnDate) {
    const chart = calculateChart(returnDate, profile);
 ...
 */
export function calculateSecondaryProgressions(profile, currentDate) {
    const birthDate = new Date(profile.birthDate);
 ...
 */
function calculateChart(date, profile) {
 ...
 */
function calculateProgressedPlanets(progressedDate, profile) {
    const progressed = {};
 ...
 */
function calculateProgressedAspects(progressedPlanets) {
    const aspects = [];
 ...
 */
function generateAspectInterpretation(planet1, planet2, aspect) {
 ...
 */
function generateSolarReturnThemes(chart, age) {
    const themes = [];
 ...
 */
function generateSolarReturnInterpretation(chart, age) {
 ...
 */
function generateYearAheadForecast(chart) {
    const houseThemes = {
 ...
 */
function generateLunarReturnThemes(chart) {
    return [
 ...
 */
function generateLunarReturnInterpretation(chart) {
 ...
 */
function generateProgressionThemes(aspects) {
    const themes = [];
 ...
 */
function generateProgressionInterpretation(aspects, daysSinceBirth) {
