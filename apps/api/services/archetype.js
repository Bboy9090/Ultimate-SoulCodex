...
export function synthesizeArchetype(astrologyData, numerologyData, personalityData) {
    const keywords = [];
    ...
    for (const archetype of archetypes) {
        const matches = archetype.keywords.filter(keyword => keywords.some(k => k.includes(keyword) || keyword.includes(k))).length;
