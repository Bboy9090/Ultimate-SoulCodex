...
export function calculateEnneagram(responses) {
    ...
    return {
        type,
        description: enneagramTypes[type].description,
        motivation: enneagramTypes[type].motivation,
        fear: enneagramTypes[type].fear
    };
}
