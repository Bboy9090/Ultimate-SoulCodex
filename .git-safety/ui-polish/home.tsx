yea goo import { Link } from "wouter";
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="cosmic-border mystical-glow">
              <Card className="cosmic-border-inner nebula-premium-panel p-8 border-0 transition-all duration-300">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center space-x-2 mb-2">
                    <h3 className="text-2xl font-bold starlit-heading">Full Soul Codex</h3>
                ...
                <Button className="w-full py-3 font-semibold text-[#120a2a] bg-gradient-to-r from-[#f6db9a] via-[#f2c94c] to-[#e6a817] hover:opacity-95" data-testid="button-unlock-complete-codex">
      ...
      <section id="how-it-works" className="py-20 cosmic-gradient">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 starlit-icon-orb">
