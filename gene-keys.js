...
export function calculateGeneKeys(sunGate, earthGate, moonGate, personalityData) {
    ...
    const currentLevel = assessGeneKeyLevel(personalityData?.enneagram?.type, personalityData?.mbti?.type);
    return {
        lifeWork: {
            key: lifeWorkKey,
