...
const memoizedGenerateSabianSymbol = memoize(generateSabianSymbolWithAI, {
    primitive: true,
...
export async function calculateSabianSymbols(sunLongitude, moonLongitude, ascendantLongitude) {
