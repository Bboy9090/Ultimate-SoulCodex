...
export const STATEMENTS: Statement[] = [
  ...
  {
    id: "cp-texting-ghost",
    text: "I stop answering messages when the energy feels off. I tell myself I'm protecting my peace, but I'm actually just avoiding the confrontation of a mismatch.",
    section: "core_pattern",
    tags: ["privacy", "boundaries"],
    behaviorBoosts: ["socialEnergy:sensitive", "pressureStyle:withdraw"],
    distinctiveness_base: 0.9,
    generic_risk: 0.1,
    has_contradiction: true,
  },
  {
    id: "cp-decision-delay",
    text: "I wait until the very last second to commit, keeping my options open until the world forces the choice for me.",
    section: "core_pattern",
    tags: ["freedom"],
    behaviorBoosts: ["decisionStyle:avoidance", "stressElement:air"],
    distinctiveness_base: 0.85,
    generic_risk: 0.2,
    has_contradiction: false,
  },
  {
    id: "cp-selective-honesty",
    text: "I don't lie, but I am extremely selective about which truths I share. I use precision as a shield to keep people at a safe distance.",
    section: "core_pattern",
    tags: ["truth", "privacy"],
    behaviorBoosts: ["decisionStyle:analysis", "stressElement:metal"],
    distinctiveness_base: 0.9,
    generic_risk: 0.1,
    has_contradiction: true,
  },
  ...
  {
    id: "cp-message-audit",
    text: "I rewrite messages three times before sending them, then delete the whole thing because the potential for being misread is too high to risk.",
    section: "core_pattern",
    tags: ["precision", "privacy"],
    behaviorBoosts: ["decisionStyle:analysis", "stressElement:metal"],
  ...
  {
    id: "cp-priority-flip",
    text: "I respond instantly to things that don't matter and delay the ones that do for weeks. I use trivial tasks to feel 'capable' while the high-stakes work waits.",
    section: "core_pattern",
    tags: ["order", "intensity"],
    behaviorBoosts: ["stressElement:air", "pressureStyle:freeze"],
    distinctiveness_base: 0.9,
    generic_risk: 0.1,
    has_contradiction: true,
  },
  {
    id: "cp-social-demand",
    text: "I ignore messages for days, but when I finally reach out, I expect immediate clarity and presence from the other person.",
    section: "core_pattern",
    tags: ["intensity", "boundaries"],
    behaviorBoosts: ["stressElement:fire", "socialEnergy:bursts"],
    distinctiveness_base: 0.9,
    generic_risk: 0.1,
    has_contradiction: true,
  },
  {
    id: "cp-app-switch",
    text: "I type a reply, then switch apps and forget I was mid-conversation because the energy of the exchange already reached its peak in my head.",
    section: "core_pattern",
    tags: ["intensity", "social_sensitivity"],
    behaviorBoosts: ["socialEnergy:bursts", "stressElement:air"],
    distinctiveness_base: 0.95,
    generic_risk: 0.05,
    has_contradiction: false,
  },
  {
    id: "cp-audit-logs",
    text: "I reread old conversations to check if I said something wrong days later, auditing my own history for potential 'energy leaks' or misalignments.",
    section: "core_pattern",
    tags: ["privacy", "precision"],
    behaviorBoosts: ["decisionStyle:analysis", "stressElement:water"],
    distinctiveness_base: 0.95,
    generic_risk: 0.05,
    has_contradiction: true,
  },
