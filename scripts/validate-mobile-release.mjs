...
if (platform === "ios") {
  ...
  requireMatch("ios/App/App.xcodeproj/project.pbxproj", /CURRENT_PROJECT_VERSION = 4000006;/, "The iOS Xcode build number must be 4000006.");
  ...
  requireMatch("ios/App/App/Info.plist", /<key>CFBundleVersion<\/key>\s*<string>4000006<\/string>/, "The iOS build number must be 4000006 for the 4.0.1 store release.");
}
...
if (platform === "android") {
  ...
  requireMatch("android/app/build.gradle", /versionCode\s+4000006/, "The Android versionCode must be 4000006 for the 4.0.1 store release.");
