...
export function calculatePersonalDayNumber(birthDate, currentDate = new Date()) {
...
export function calculateUniversalDayNumber(currentDate = new Date()) {
...
export function getCurrentHDGate(date) {
...
export function getDailyContext(birthDate, currentDate = new Date()) {
