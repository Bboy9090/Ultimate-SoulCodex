...
export const SOUL_CODEX_SYSTEM_POLICIES = {
  ...
  runes: {
    ...
    mayInfluencePrimarySynthesis: false,
    inspectableWhenUnverified: true,
    rule: "Deterministic rune mappings may be inspected as symbolic reflection only; they are not verified biographical facts and do not influence primary synthesis.",
  },
  sacredGeometry: {
    id: "sacred-geometry",
    ...
    mayInfluencePrimarySynthesis: false,
    inspectableWhenUnverified: true,
    rule: "Deterministic geometry mappings may be inspected as symbolic reflection only; they do not establish factual identity traits or influence primary synthesis.",
  },
  palmistry: {
    id: "palmistry",
    label: "Palmistry",
