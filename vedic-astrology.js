...
export function calculateVedicAstrology(params) {
    ...
    const moonSidereal = tropicalToSidereal(moonEcl.elon || moonEcl.lon);
    ...
    return {
        ...
        planets: {
            sun: processPlanet('sun', sunEcl.elon || sunEcl.lon),
            moon: processPlanet('moon', moonEcl.elon || moonEcl.lon),
            mercury: processPlanet('mercury', mercuryEcl.elon || mercuryEcl.lon),
            venus: processPlanet('venus', venusEcl.elon || venusEcl.lon),
            mars: processPlanet('mars', marsEcl.elon || marsEcl.lon),
            jupiter: processPlanet('jupiter', jupiterEcl.elon || jupiterEcl.lon),
            saturn: processPlanet('saturn', saturnEcl.elon || saturnEcl.lon),
