...
export function calculateChakraSystem(astrologyData, numerologyData, personalityData) {
    const activations = CHAKRAS.map((chakra, index) => {
    ...
    const dominantChakra = activations.reduce((max, curr) => curr.activationLevel > max.activationLevel ? curr : max);
